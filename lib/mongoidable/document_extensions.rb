...
module Mongoidable
  ...
  module DocumentExtensions
    ...
    included do
      ...
      embeds_many :instance_abilities, class_name: Mongoidable.configuration.ability_class, after_add: :renew_instance_abilities, after_remove: :renew_instance_abilities do
